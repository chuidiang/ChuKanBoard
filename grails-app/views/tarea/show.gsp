                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean: tareaInstance, field: "estado")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="tarea.fechaComienzo.label" default="Fecha Comienzo" /></td>
                            
                            <td valign="top" class="value"><g:formatDate date="${tareaInstance?.fechaComienzo}" /></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="tarea.personaAsignada.label" default="Persona Asignada" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: tareaInstance, field: "personaAsignada")}</td>
